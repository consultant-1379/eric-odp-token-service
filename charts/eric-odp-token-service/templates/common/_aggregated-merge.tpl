...
*/ -}}
{{- define "eric-odp-token-service.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-odp-token-service.mergeAnnotations" -}}
  {{- include "eric-odp-token-service.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-odp-token-service.mergeLabels" -}}
  {{- include "eric-odp-token-service.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
